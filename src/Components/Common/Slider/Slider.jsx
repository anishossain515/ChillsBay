  ...
  return (
    <section className="mt-10">
      <div className="space-y-10">
       ...
       <h1 className="text-Dark_Indigo font-bold lg:text-[42px] md:text-4xl text-3xl text-center px-2 sm:block hidden">See How People are Chilling On Chillsbay</h1>
